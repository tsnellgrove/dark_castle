"Dark Castle" is a very simple Zork-like adventure game. I have written it in order to teach myself Python. The program is written using Pythonista on an iPad.
