...
#	Create "eat" command but don't let burt eat the biscut
...
#			need to read scroll in throne room while wearing crown; 
#			scroll sepcifies need for hedgehog to be in castle
